# :basketball: Notes and conclusions of `05-trainCombined.ipynb`

## Dataset
The dataset used in this notebook can be found in `data/basketball-combined.yolov8`.
...
## Outputs
All evaluation metrics are exported to a CSV file called `combined_metrics.csv` inside the `results`-folder.
